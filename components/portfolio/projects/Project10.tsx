...
import { Building2, Bell, Compass, CircleDot } from "lucide-react";
        ...
        <div className="relative px-6 pt-12 pb-16 space-y-8">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Building2, label: "Prayer Tracker", color: "from-teal-500/20 to-emerald-500/20", iconColor: "text-teal-400" },
                { icon: Bell, label: "Smart Reminders", color: "from-blue-500/20 to-cyan-500/20", iconColor: "text-blue-400" },
                { icon: Compass, label: "Qibla Finder", color: "from-green-500/20 to-emerald-500/20", iconColor: "text-green-400" },
                { icon: CircleDot, label: "Streak System", color: "from-purple-500/20 to-pink-500/20", iconColor: "text-purple-400" },
              ].map((item, idx) => {
