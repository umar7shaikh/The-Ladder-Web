...
import { Palette, Sparkles, Film, Heart } from "lucide-react";
        ...
        <div className="relative px-6 pt-12 pb-16 space-y-8">
          ...
          >
            <p className="text-gray-400 text-sm leading-relaxed">
              To revamp Trevon&apos;s event page for a visually rich, brand-aligned, and user-engaging experience—enhancing visual appeal, consistency, and interactivity while maintaining the app&apos;s existing functionality and flow.
            </p>
            
            {/* Quick Tags */}
            <div className="flex flex-wrap gap-2">
              {["Wedding App", "UI Redesign", "Event Planning", "Mobile"].map((tag, idx) => (
                <span 
                  key={idx}
              ...
              <div className="relative bg-black border border-red-500/20 rounded-2xl p-5 space-y-3">
                ...
                <ul className="text-gray-400 text-sm leading-relaxed space-y-2 pl-13">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Outdated UI with minimal emotional connection and weak brand reflection.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-600 mt-1">•</span>
                    <span>Inconsistent hierarchy and lack of engaging visual rhythm.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-600 mt-1">•</span>
                    <span>Static experience with no interactive feedback or movement.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-600 mt-1">•</span>
                    <span>Disconnected tone between Trevon&apos;s brand identity and the event page aesthetics.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-black border border-yellow-500/20 rounded-2xl p-5 space-y-3">
                ...
                <p className="text-gray-400 text-sm leading-relaxed pl-13 italic mb-2">
                  A refreshed, responsive event page that:
                </p>
                <ul className="text-gray-400 text-sm leading-relaxed space-y-2 pl-13">
                  <li className="flex items-start gap-2">
                    <span className="text-gray-600 mt-1">•</span>
                    <span>Integrates Trevon&apos;s core brand colours (yellow and pink) for harmony and recognition.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-600 mt-1">•</span>
                    <span>Introduces gradient headers, improved typography, and visual hierarchy for clarity.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-600 mt-1">•</span>
                    <span>Adds subtle fade-in animations and parallax effects to enhance user engagement.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-gray-600 mt-1">•</span>
                    <span>Creates a warm, festive, and seasonal look that aligns with Trevon&apos;s purpose and style.</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Palette, label: "Brand Alignment", color: "from-yellow-500/20 to-amber-500/20", iconColor: "text-yellow-400" },
                { icon: Sparkles, label: "Visual Hierarchy", color: "from-orange-500/20 to-red-500/20", iconColor: "text-orange-400" },
                { icon: Film, label: "Subtle Animations", color: "from-purple-500/20 to-pink-500/20", iconColor: "text-purple-400" },
                { icon: Heart, label: "Festive Design", color: "from-pink-500/20 to-rose-500/20", iconColor: "text-pink-400" },
              ].map((item, idx) => {
          ...
          >
            ...
            <p className="text-gray-300 text-sm leading-relaxed italic relative z-10">
              "A visually stunning remodel that brings Trevon&apos;s wedding event experience to life with brand harmony and engaging interactivity."
            </p>
          </motion.div>
      ...
      <div className="hidden lg:block overflow-x-hidden">
        ...
        <section className="relative w-full bg-black min-h-dvh">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 min-h-dvh">
            ...
            >
              ...
              <div className="space-y-[3vh]">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed text-[clamp(14px,1.2vw,18px)]">
                    UI/UX Designer — Handled visual redesign, layout restructuring, color system alignment, and micro-interaction detailing, ensuring a cohesive, scalable, and user-focused interface within a short 2-day sprint.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-[80%] h-[85vh]">
                <Image
                  src="/projects/project15/ss1.svg"
                  alt="Trevon app wedding plan screen"
                  fill
        ...
        {/* SECTION 2 - TWO COMPARISON IMAGES */}
        <section className="relative w-full bg-black min-h-dvh">
          <div className="absolute inset-0 opacity-30 pointer-events-none" aria-hidden="true">
            <div className="w-full h-full bg-[image:radial-gradient(circle,rgba(255,255,255,0.15)_1px,transparent_1px)] [background-size:24px_24px]" />
          </div>
          ...
          >
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-yellow-500/20 blur-[100px] rounded-full -z-10 pointer-events-none" />
          ...
          <div className="relative flex items-center justify-center min-h-dvh px-[5vw] py-[15vh]">
            <div className="grid grid-cols-2 gap-[3vw] w-full max-w-[1400px]">
              {[
                "/projects/project15/ss2.png",
                "/projects/project15/ss3.png"
              ].map((src, idx) => (
                <motion.div
                  key={idx}
                ...
                >
                  <Image
                    src={src}
                    alt={idx === 0 ? "Old Design" : "New Design"}
                    fill
                    className="object-contain"
                    quality={85}
                    sizes="50vw"
        ...
        <section className="relative w-full bg-black min-h-dvh">
          ...
          <div className="relative grid grid-cols-2 min-h-dvh">
            ...
            <motion.div
              ...
              className="relative px-[5vw] py-[5vh] flex items-center justify-center"
            >
<div className="relative w-[90%] h-[85vh]">
  <Image
    src="/projects/project15/ss4.svg"
    alt="Trevon app full event page"
    fill
    className="object-contain"
    quality={85}
    sizes="40vw"
