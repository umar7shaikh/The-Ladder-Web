...
import { Palette, Smartphone, Search, Target } from "lucide-react";
        ...
        <div className="relative px-6 pt-12 pb-16 space-y-8">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Palette, label: "Clean Visual Design", color: "from-purple-500/20 to-pink-500/20", iconColor: "text-purple-400" },
                { icon: Smartphone, label: "Fully Responsive", color: "from-cyan-500/20 to-blue-500/20", iconColor: "text-cyan-400" },
                { icon: Search, label: "SEO Structure", color: "from-green-500/20 to-emerald-500/20", iconColor: "text-green-400" },
                { icon: Target, label: "Clear Journey & CTAs", color: "from-orange-500/20 to-red-500/20", iconColor: "text-orange-400" },
              ].map((item, idx) => {
