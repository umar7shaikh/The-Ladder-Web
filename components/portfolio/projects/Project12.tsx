...
import { Home, Smartphone, Search, Briefcase } from "lucide-react";
        ...
        <div className="relative px-6 pt-12 pb-16 space-y-8">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Home, label: "Modern Design", color: "from-red-500/20 to-rose-500/20", iconColor: "text-red-400" },
                { icon: Smartphone, label: "Mobile Optimized", color: "from-cyan-500/20 to-blue-500/20", iconColor: "text-cyan-400" },
                { icon: Search, label: "SEO Ready", color: "from-green-500/20 to-emerald-500/20", iconColor: "text-green-400" },
                { icon: Briefcase, label: "Lead Generation", color: "from-orange-500/20 to-yellow-500/20", iconColor: "text-orange-400" },
              ].map((item, idx) => {
