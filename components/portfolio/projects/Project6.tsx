...
import { Shield, Target, Briefcase, BarChart3 } from "lucide-react";
...
export default function Project6() {
  ...
  const allImages = [
    { src: "/projects/project6/ss1.png", alt: "Cyber Mitra landing page hero", aspect: "9/16" },
    { src: "/projects/project6/ss2.png", alt: "Cybersecurity services section", aspect: "9/16" },
    { src: "/projects/project6/ss3.png", alt: "Trust signals and contact section", aspect: "16/9" },
    { src: "/projects/project6/ss4.png", alt: "Cyber Mitra services and contact section", aspect: "16/9" },
  ];
        ...
        <div className="relative px-6 pt-12 pb-16 space-y-8">
          ...
          >
            <p className="text-gray-400 text-sm leading-relaxed">
              A conversion-focused landing page for a cybersecurity services company, designed to educate visitors about digital threats while establishing trust and driving lead generation through clear CTAs and professional design.
            </p>
            
            {/* Quick Tags */}
            <div className="flex flex-wrap gap-2">
              {["Cybersecurity", "Landing Page", "B2B", "Lead Gen"].map((tag, idx) => (
                <span 
                  key={idx}
                ...
                >
                  ...
                  <div className="flex gap-4">
                    {allImages.map((image, idx) => (
                      ...
                      >
                        {/* Glow Effect */}
                        <div className="absolute inset-0 bg-gradient-to-t from-teal-500/20 via-transparent to-orange-500/20 opacity-0 hover:opacity-100 transition-opacity duration-300 z-10" />
          ...
          >
            ...
            <div className="relative group">
              ...
              <div className="relative bg-black border border-red-500/20 rounded-2xl p-5 space-y-3">
                ...
                <p className="text-gray-400 text-sm leading-relaxed pl-13">
                  Cybersecurity services are complex and technical. The company needed a landing page that could simplify their offerings, build immediate trust, and convert technical decision-makers without overwhelming them with jargon.
                </p>
              </div>
            </div>
            ...
            {/* Solution Card */}
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-teal-500/50 to-orange-500/50 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-300" />
              <div className="relative bg-black border border-teal-500/20 rounded-2xl p-5 space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500/20 to-orange-500/20 flex items-center justify-center">
                    <span className="text-teal-400 text-xl">✓</span>
                  </div>
                  <h3 className="font-bold text-white text-lg">The Solution</h3>
                </div>
                <p className="text-gray-400 text-sm leading-relaxed pl-13">
                  Designed a clean, single-page experience with strategic sections: hero with clear value proposition, service highlights with icons, trust signals, and prominent contact CTAs. Used engaging visuals and concise copy to make cybersecurity approachable.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <h3 className="font-semibold text-white text-base flex items-center gap-2">
              <span className="w-1 h-6 bg-gradient-to-b from-teal-500 to-orange-500 rounded-full" />
              Key Deliverables
            </h3>
            
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Shield, label: "Clear Value Proposition", color: "from-teal-500/20 to-blue-500/20", iconColor: "text-teal-400" },
                { icon: Target, label: "Strategic CTAs", color: "from-orange-500/20 to-red-500/20", iconColor: "text-orange-400" },
                { icon: Briefcase, label: "Professional Design", color: "from-purple-500/20 to-pink-500/20", iconColor: "text-purple-400" },
                { icon: BarChart3, label: "Trust-Building Elements", color: "from-green-500/20 to-emerald-500/20", iconColor: "text-green-400" },
              ].map((item, idx) => {
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative mt-8 p-6 rounded-2xl bg-gradient-to-br from-teal-500/10 to-orange-500/10 border border-teal-500/20"
          >
            ...
            <p className="text-gray-300 text-sm leading-relaxed italic relative z-10">
              "A focused landing page that transforms complex cybersecurity services into clear, actionable solutions—building trust and driving conversions."
            </p>
          </motion.div>
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 min-h-dvh">
              ...
              <div className="space-y-[3vh]">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed text-[clamp(14px,1.2vw,18px)]">
                    To create a conversion-focused landing page for a cybersecurity services company that educates visitors about digital threats, establishes credibility, and drives lead generation through clear messaging and strategic design.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed text-[clamp(14px,1.2vw,18px)]">
                    UI/UX Designer + Web Developer — I designed the complete user journey, visual identity, and developed the responsive landing page with focus on conversion optimization.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-full h-full">
                <Image
                  src="/projects/project6/ss1.png"
                  alt="Cyber Mitra landing page hero section"
                  fill
        ...
        <section className="relative w-full bg-black min-h-dvh">
          ...
          <div className="relative flex items-center justify-center min-h-dvh px-[5vw] py-[10vh]">
            <div className="grid grid-cols-2 gap-[3vw] w-full max-w-[1400px]">
              {["/projects/project6/ss2.png", "/projects/project6/ss3.png"].map((src, idx) => (
                <motion.div
                  key={idx}
        ...
        <section className="relative w-full bg-black min-h-dvh">
          ...
          <div className="relative grid grid-cols-2 min-h-dvh">
              ...
              <div className="space-y-[3vh]">
                ...
                <div>
                  ...
                  <ul className="space-y-[1vh] text-gray-400 text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    <li className="flex items-start gap-3">
                      ...
                      <span>Cybersecurity services are inherently complex and technical—difficult to explain in simple terms without losing credibility.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>The company needed to build immediate trust with technical decision-makers while keeping the content accessible and conversion-focused.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-400 italic mb-[1vh] text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    A streamlined landing page that balances technical credibility with accessibility:
                  </p>
                  <ul className="space-y-[1vh] text-gray-400 text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Clean, professional design with strategic use of whitespace and a teal-orange color scheme for visual hierarchy.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Clear service sections with icons and concise descriptions—making complex offerings easy to scan and understand.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Multiple contact CTAs and trust signals positioned throughout to maximize lead generation opportunities.</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            >
              ...
              >
                <Image
                  src="/projects/project6/ss4.png"
                  alt="Cyber Mitra services and contact section"
                  fill
                  className="object-contain"
                  quality={85}
                  sizes="45vw"
