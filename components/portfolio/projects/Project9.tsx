...
import { Car, Palette, Smartphone, Star } from "lucide-react";
  ...
  return (
    <>
        ...
        <div className="relative px-6 pt-12 pb-16 space-y-8">
          ...
          >
            <p className="text-gray-400 text-sm leading-relaxed">
              A UI & UX-based car wash-themed project; a modern mobile app for private branches that makes booking car washes minimal effort—sleek, intuitive, and easy.
            </p>
            
            {/* Quick Tags */}
            <div className="flex flex-wrap gap-2">
              {["Mobile App", "Car Wash", "Booking", "UI/UX"].map((tag, idx) => (
                <span 
                  key={idx}
                ...
                >
                  ...
                  <div className="flex gap-4">
                    {allImages.map((image, idx) => (
                      ...
                      >
                        {/* Glow Effect */}
                        <div className="absolute inset-0 bg-gradient-to-t from-cyan-500/20 via-transparent to-blue-500/20 opacity-0 hover:opacity-100 transition-opacity duration-300 z-10" />
          ...
          >
            ...
            <div className="relative group">
              ...
              <div className="relative bg-black border border-red-500/20 rounded-2xl p-5 space-y-3">
                ...
                <p className="text-gray-400 text-sm leading-relaxed pl-13">
                  The brand had no digital presence—users couldn&apos;t schedule appointments or interact with the brand seamlessly. The client&apos;s core requirements included service rewards that were currently not included.
                </p>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-black border border-cyan-500/20 rounded-2xl p-5 space-y-3">
                ...
                <p className="text-gray-400 text-sm leading-relaxed pl-13">
                  A fresh UI design with in-track booking flow, modern visuals, and customizable features that keep real-time customer account stats—balancing simplicity, functionality, and care for the premium experience.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Car, label: "Easy Booking Flow", color: "from-blue-500/20 to-cyan-500/20", iconColor: "text-blue-400" },
                { icon: Palette, label: "Modern UI Design", color: "from-purple-500/20 to-pink-500/20", iconColor: "text-purple-400" },
                { icon: Smartphone, label: "Mobile Optimized", color: "from-cyan-500/20 to-blue-500/20", iconColor: "text-cyan-400" },
                { icon: Star, label: "Reward System", color: "from-yellow-500/20 to-orange-500/20", iconColor: "text-yellow-400" },
              ].map((item, idx) => {
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative mt-8 p-6 rounded-2xl bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20"
          >
            ...
            <p className="text-gray-300 text-sm leading-relaxed italic relative z-10">
              "Transforming car wash booking into a sleek, intuitive experience—where minimal effort meets maximum convenience."
            </p>
          </motion.div>
      ...
      <div className="hidden lg:block overflow-x-hidden">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 min-h-dvh">
              ...
              <div className="space-y-[3vh]">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed text-[clamp(14px,1.2vw,18px)]">
                    A UI & UX-based car wash-themed project; a modern mobile app for its private branches. Booking on-the-go with minimal effort—washing made easy.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed text-[clamp(14px,1.2vw,18px)]">
                    UI/UX Designer — From ideation to final design, I shaped the user flow to be sleek, intuitive, and visually polished.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-[45%] h-[85vh]">
                <Image
                  src="/projects/project9/ss1.png"
                  alt="Q8 Car Wash splash screen"
                  fill
              ...
              <div className="relative w-[45%] h-[85vh]">
                <Image
                  src="/projects/project9/ss2.png"
                  alt="Q8 Car Wash home screen"
                  fill
                  className="object-contain"
                  quality={85}
                  priority
        ...
        {/* SECTION 2 - FIVE IMAGES STAGGERED */}
<section className="relative w-full bg-black min-h-dvh">
  <div className="absolute inset-0 opacity-30 pointer-events-none" aria-hidden="true">
    <div className="w-full h-full bg-[image:radial-gradient(circle,rgba(255,255,255,0.15)_1px,transparent_1px)] [background-size:24px_24px]" />
  </div>
  ...
  >
    ...
    <div className="relative inline-block px-[2vw] py-[1vh] rounded-full bg-[#D8F209] border border-[#D8F209] shadow-lg shadow-[#D8F209]/60">
      <span className="text-black font-medium text-[clamp(11px,1vw,15px)]">
        Q8 Car Wash - Mobile Application
      </span>
    </div>
  </motion.div>

  <div className="relative flex items-center justify-center min-h-dvh px-[5vw] py-[10vh] pt-[15vh]">
    <div className="flex gap-[2vw] w-full max-w-[1600px] items-center">
      {[
        { src: "/projects/project9/ss3.png", offset: "translate-y-[2vh]" },
        { src: "/projects/project9/ss4.png", offset: "translate-y-[-3vh]" },
        { src: "/projects/project9/ss5.png", offset: "translate-y-[1vh]" },
        { src: "/projects/project9/ss6.png", offset: "translate-y-[-2vh]" },
        { src: "/projects/project9/ss7.png", offset: "translate-y-[0vh]" }
      ].map((image, idx) => (
        <motion.div
          key={idx}
          ...
          viewport={{ once: true }}
          className={`relative w-full h-[70vh] ${image.offset}`}
        >
          <Image
            src={image.src}
            alt={`Q8 Car Wash screen ${idx + 3}`}
            fill
            className="object-contain"
            quality={85}
            sizes="20vw"
        ...
        <section className="relative w-full bg-black min-h-dvh">
          ...
          <div className="relative grid grid-cols-2 min-h-dvh">
              ...
              <div className="space-y-[3vh]">
                ...
                <div>
                  ...
                  <ul className="space-y-[1vh] text-gray-400 text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    <li className="flex items-start gap-3">
                      ...
                      <span>The brand had no digital presence—users couldn&apos;t schedule appointments or interact with the brand seamlessly.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>The client&apos;s core requirements included service rewards that were currently not included.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-400 italic mb-[1vh] text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    A complete mobile app experience:
                  </p>
                  <ul className="space-y-[1vh] text-gray-400 text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>A fresh UI design with in-track booking flow and modern visuals.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Customizable features that keep real-time customer account stats.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Balancing simplicity, functionality, and care for the premium experience.</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            >
              ...
              >
                <Image
                  src="/projects/project9/ss8.svg"
                  alt="Q8 Car Wash user flow diagram"
                  fill
                  className="object-contain"
                  quality={85}
                  sizes="45vw"
