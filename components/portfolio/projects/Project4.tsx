...
import { Heart, MessageCircle, Palette, Building2 } from "lucide-react";
...
export default function Project4() {
  ...
  const allImages = [
    ...
    { src: "/projects/project4/ss4.svg", alt: "Messaging and community", aspect: "16/9" },
    ...
    <>
      ...
      <section ref={sectionRef} className="lg:hidden relative w-full bg-black">
        ...
        <div className="relative px-6 pt-12 pb-16 space-y-8">
          ...
          >
            {/* Animated Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-orange-500/30 bg-orange-500/5 backdrop-blur-sm">
            ...
            <div className="space-y-1">
              ...
              <p className="font-bold text-xl leading-none text-gray-500">
                UI/UX Designer & Experience Curator
              </p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="h-px bg-gradient-to-r from-transparent via-orange-500/50 to-transparent origin-left"
          />
          ...
          >
            <p className="text-gray-400 text-sm leading-relaxed">
              A community-driven platform where pet parents can showcase their furry (or feathery, or scaly) companions, connect with other owners, and even discover pet services nearby.
            </p>
            
            {/* Quick Tags */}
            <div className="flex flex-wrap gap-2">
              {["Pet Social", "Community", "Playful UI", "Pet Services"].map((tag, idx) => (
                <span 
                  key={idx}
                ...
                >
                  ...
                  <div className="flex gap-4">
                    {allImages.map((image, idx) => (
                      ...
                      >
                        {/* Glow Effect */}
                        <div className="absolute inset-0 bg-gradient-to-t from-orange-500/20 via-transparent to-yellow-500/20 opacity-0 hover:opacity-100 transition-opacity duration-300 z-10" />
          ...
          >
            ...
            <div className="relative group">
              ...
              <div className="relative bg-black border border-red-500/20 rounded-2xl p-5 space-y-3">
                ...
                <p className="text-gray-400 text-sm leading-relaxed pl-13">
                  Pet lovers have no unified, feel-good platform to share their pets' profiles, keep digital records, or connect with other pet owners. Most pet platforms feel like marketplaces or forums—not personal spaces for the pets themselves.
                </p>
              </div>
            </div>
            ...
            {/* Solution Card */}
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-orange-500/50 to-yellow-500/50 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-300" />
              <div className="relative bg-black border border-orange-500/20 rounded-2xl p-5 space-y-3">
                ...
                <p className="text-gray-400 text-sm leading-relaxed pl-13">
                  Designed a fun, pets-first experience where users could create pet profiles, upload memories, get tips, and build a cute little digital scrapbook. UI was crafted to be playful, warm, and engaging—just like a walk in the park 🐾
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <h3 className="font-semibold text-white text-base flex items-center gap-2">
              <span className="w-1 h-6 bg-gradient-to-b from-orange-500 to-yellow-500 rounded-full" />
              Key Deliverables
            </h3>
            
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Heart, label: "Pet Profiles & Scrapbook", color: "from-pink-500/20 to-rose-500/20", iconColor: "text-pink-400" },
                { icon: MessageCircle, label: "Community Connection", color: "from-blue-500/20 to-cyan-500/20", iconColor: "text-blue-400" },
                { icon: Palette, label: "Playful, Warm UI", color: "from-orange-500/20 to-yellow-500/20", iconColor: "text-orange-400" },
                { icon: Building2, label: "Pet Services Discovery", color: "from-purple-500/20 to-indigo-500/20", iconColor: "text-purple-400" },
              ].map((item, idx) => {
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative mt-8 p-6 rounded-2xl bg-gradient-to-br from-orange-500/10 to-yellow-500/10 border border-orange-500/20"
          >
            ...
            <p className="text-gray-300 text-sm leading-relaxed italic relative z-10">
              "A pets-first digital experience that brings warmth, playfulness, and community to pet parents everywhere."
            </p>
          </motion.div>
      ...
      <div className="hidden lg:block overflow-x-hidden">
        ...
        <section className="relative w-full bg-black min-h-dvh">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 min-h-dvh">
            ...
            >
              <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-orange-500/20 blur-[120px] rounded-full -z-10 pointer-events-none" />
              ...
              <div className="space-y-[3vh]">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed text-[clamp(14px,1.2vw,18px)]">
                    Aimed to create a community-driven platform where pet parents can showcase their furry (or feathery, or scaly) companions, connect with other owners, and even discover pet services nearby.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed text-[clamp(14px,1.2vw,18px)]">
                    UI/UX Designer + Experience Curator — I handled everything from feature layout to emotional tone through design.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-full h-full">
                <Image
                  src="/projects/project4/ss1.png"
                  alt="MeetMyPets website homepage"
                  fill
        ...
        <section className="relative w-full bg-black min-h-dvh">
          ...
          >
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-orange-500/20 blur-[100px] rounded-full -z-10 pointer-events-none" />
          ...
          <div className="relative flex items-center justify-center min-h-dvh px-[5vw] py-[10vh]">
            <div className="grid grid-cols-2 gap-[3vw] w-full max-w-[1400px]">
              {["/projects/project4/ss2.png", "/projects/project4/ss3.png"].map((src, idx) => (
                <motion.div
                  key={idx}
        ...
        <section className="relative w-full bg-black min-h-dvh">
          ...
          <div className="relative grid grid-cols-2 min-h-dvh">
              ...
              <div className="space-y-[3vh]">
                ...
                <div>
                  ...
                  <ul className="space-y-[1vh] text-gray-400 text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    <li className="flex items-start gap-3">
                      ...
                      <span>Pet lovers have no unified, feel-good platform to share their pets' profiles, keep digital records, or connect with other pet owners.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Most pet platforms feel like marketplaces or forums—not personal spaces for the pets themselves.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-400 italic mb-[1vh] text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    A pets-first digital experience that includes:
                  </p>
                  <ul className="space-y-[1vh] text-gray-400 text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Designed a fun, pets-first experience where users could create pet profiles, upload memories, get tips, and build a cute little digital scrapbook.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>UI was crafted to be playful, warm, and engaging—just like a walk in the park 🐾</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Community features to connect pet owners and discover local pet services like vets, groomers, and trainers.</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            >
              ...
              >
                <Image
                  src="/projects/project4/ss4.svg"
                  alt="MeetMyPets comprehensive pet care features"
                  fill
                  className="object-contain"
                  quality={85}
                  sizes="45vw"
