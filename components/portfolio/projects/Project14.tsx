...
import { ShoppingBag, Handshake, BarChart3, Newspaper } from "lucide-react";
        ...
        <div className="relative px-6 pt-12 pb-16 space-y-8">
          ...
          >
            <p className="text-gray-400 text-sm leading-relaxed">
              A B2B website designed for bakeries and food manufacturers, showcasing cutting-edge ingredients, innovative solutions, and expert guidance to elevate baking quality.
            </p>
            
            {/* Quick Tags */}
            <div className="flex flex-wrap gap-2">
              {["B2B", "Bakery Solutions", "Food Industry", "Website"].map((tag, idx) => (
                <span 
                  key={idx}
                ...
                >
                  ...
                  <div className="flex gap-4">
                    {allImages.map((image, idx) => (
                      ...
                      >
                        {/* Glow Effect */}
                        <div className="absolute inset-0 bg-gradient-to-t from-amber-500/20 via-transparent to-orange-500/20 opacity-0 hover:opacity-100 transition-opacity duration-300 z-10" />
          ...
          >
            ...
            <div className="relative group">
              ...
              <div className="relative bg-black border border-red-500/20 rounded-2xl p-5 space-y-3">
                ...
                <p className="text-gray-400 text-sm leading-relaxed pl-13">
                  Enessa Foods needed a professional B2B website to showcase their bakery ingredients and solutions to manufacturers, but lacked a clear digital presence that communicated their expertise and product range effectively.
                </p>
              </div>
            </div>
            ...
            {/* Solution Card */}
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-amber-500/50 to-orange-500/50 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-300" />
              <div className="relative bg-black border border-amber-500/20 rounded-2xl p-5 space-y-3">
                <div className="flex items-center gap-3">
                ...
                <p className="text-gray-400 text-sm leading-relaxed pl-13">
                  A warm, professional website with an earthy color palette that highlights their product range, partnerships, testimonials, and expert resources. Designed with clear CTAs for B2B inquiries and a blog section for industry insights.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: ShoppingBag, label: "Product Showcase", color: "from-amber-500/20 to-orange-500/20", iconColor: "text-amber-400" },
                { icon: Handshake, label: "B2B Focused", color: "from-blue-500/20 to-indigo-500/20", iconColor: "text-blue-400" },
                { icon: BarChart3, label: "Client Testimonials", color: "from-green-500/20 to-emerald-500/20", iconColor: "text-green-400" },
                { icon: Newspaper, label: "Industry Blog", color: "from-purple-500/20 to-pink-500/20", iconColor: "text-purple-400" },
              ].map((item, idx) => {
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative mt-8 p-6 rounded-2xl bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20"
          >
            ...
            <p className="text-gray-300 text-sm leading-relaxed italic relative z-10">
              "A professional B2B platform that positions Enessa Foods as a trusted partner in bakery innovation and quality ingredients."
            </p>
          </motion.div>
      ...
      <div className="hidden lg:block overflow-x-hidden">
        ...
        <section className="relative w-full bg-black min-h-dvh">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 min-h-dvh">
            ...
            >
              <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-amber-500/20 blur-[120px] rounded-full -z-10 pointer-events-none" />
              ...
              <div className="space-y-[3vh]">
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed text-[clamp(14px,1.2vw,18px)]">
                    A B2B website designed for bakeries and food manufacturers, showcasing cutting-edge ingredients, innovative solutions, and expert guidance to elevate baking quality and business growth.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed text-[clamp(14px,1.2vw,18px)]">
                    UI/UX Designer & Content Strategist — Designed the entire website layout, created content hierarchy, wrote copy for product pages and blog sections, and ensured a professional B2B experience.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-full h-[85vh]">
                <Image
                  src="/projects/project14/ss1.png"
                  alt="Enessa Foods website overview"
                  fill
        ...
        {/* SECTION 2 - FOUR IMAGES IN A ROW */}
        <section className="relative w-full bg-black min-h-dvh">
          <div className="absolute inset-0 opacity-30 pointer-events-none" aria-hidden="true">
            <div className="w-full h-full bg-[image:radial-gradient(circle,rgba(255,255,255,0.15)_1px,transparent_1px)] [background-size:24px_24px]" />
          </div>
          ...
          >
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-amber-500/20 blur-[100px] rounded-full -z-10 pointer-events-none" />
          ...
          <div className="relative flex items-center justify-center min-h-dvh px-[5vw] py-[15vh]">
            <div className="grid grid-cols-4 gap-[2vw] w-full max-w-[1600px]">
              {[
                "/projects/project14/ss2.png",
                "/projects/project14/ss3.png",
                "/projects/project14/ss4.png",
                "/projects/project14/ss5.png"
              ].map((src, idx) => (
                <motion.div
                  key={idx}
        ...
        <section className="relative w-full bg-black min-h-dvh">
          ...
          <div className="relative grid grid-cols-2 min-h-dvh">
              ...
              <div className="space-y-[3vh]">
                ...
                <div>
                  ...
                  <ul className="space-y-[1vh] text-gray-400 text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    <li className="flex items-start gap-3">
                      ...
                      <span>Enessa Foods needed a professional B2B website to showcase their bakery ingredients and solutions to manufacturers.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>They lacked a clear digital presence that communicated their expertise, product range, and value proposition effectively.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-400 italic mb-[1vh] text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    A warm, professional website with an earthy color palette that conveys trust and quality. Key features include:
                  </p>
                  <ul className="space-y-[1vh] text-gray-400 text-[clamp(14px,1.2vw,18px)] leading-relaxed">
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Product showcases with detailed descriptions and applications.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Client testimonials and partnership highlights to build credibility.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Industry blog section for expert insights and thought leadership.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-600 mt-1">•</span>
                      <span>Clear CTAs for B2B inquiries and partnership opportunities.</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            >
              <div className="relative w-full h-[85vh]">
                <Image
                  src="/projects/project14/ss6.png"
                  alt="Enessa Foods insights and footer"
                  fill
                  className="object-contain"
                  quality={85}
                  sizes="50vw"
