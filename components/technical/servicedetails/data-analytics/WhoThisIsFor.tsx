...
export default function WhoThisIsFor() {
  ...
  const text = "This service is ideal for businesses drowning in data but starving for insights, making decisions based on gut feeling instead of facts, struggling to identify trends and opportunities, and ready to leverage data as a competitive advantage.";
