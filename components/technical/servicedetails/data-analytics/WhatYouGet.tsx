  ...
  const deliverables = [
    {
      ...
      description: 'Real-time visualizations that let you explore data and answer questions instantly'
    },
    {
      title: 'Data pipelines & ETL processes',
      description: 'Automated data collection, cleaning, and transformation pipelines'
    },
    {
      title: 'Custom reports & KPI tracking',
      description: 'Tailored reports that track exactly what matters to your business'
    },
    {
      title: 'Data quality & validation systems',
      description: 'Automated checks ensure accuracy and reliability of all metrics'
    },
    {
      title: 'Predictive analytics models',
      description: 'Forecasting and trend analysis to anticipate future performance'
    },
    {
      title: 'Training & documentation',
      description: 'Your team learns to leverage analytics effectively with comprehensive guides'
    }
  ];
      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          <p className="text-[#FBFFDE]/60 text-lg max-w-2xl mx-auto">
            Everything you need for production-ready analytics that drives business decisions
          </p>
        </motion.div>
        ...
        >
          <p className="text-[#FBFFDE]/50 text-base max-w-2xl mx-auto">
            Every component is documented, tested, and delivered with full training and ongoing support.
          </p>
        </motion.div>
