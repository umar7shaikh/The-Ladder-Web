...
import { ArrowRight, Zap, Shield, TrendingUp, Sparkles, X, Check, BarChart3, Eye } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            <p className="text-[#FBFFDE]/60 text-xl leading-relaxed">
              Most analytics platforms show you what happened yesterday.
            </p>
            <p className="text-[#FBFFDE]/80 text-2xl leading-relaxed font-medium">
              We build <span className="text-[#D8F209]">actionable insights</span> that predict tomorrow and guide today's decisions.
            </p>
          </div>
        </motion.div>
          ...
          <div className="hidden lg:grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <div className="relative space-y-12">
                {[
                  { label: 'Data Collection', time: 'Week 1', issue: 'Raw data dump' },
                  { label: 'Basic Dashboards', time: 'Week 2-3', issue: 'No insights' },
                  { label: 'Monthly Reports', time: 'Ongoing', issue: 'Too late to act' },
                  { label: 'Manual Analysis', time: 'As needed', issue: 'Time-consuming' },
                  { label: 'Reactive Decisions', time: 'After issues', issue: 'Lost opportunities' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
            ...
            >
              ...
              <div className="relative space-y-12">
                ...
                {[
                  { label: 'Integrated Data Pipeline', benefit: 'Real-time collection' },
                  { label: 'Intelligent Dashboards', benefit: 'Self-service insights' },
                  { label: 'Predictive Analytics', benefit: 'Future-focused' },
                  { label: 'Automated Alerts', benefit: 'Proactive monitoring' },
                  { label: 'Data-Driven Decisions', benefit: 'Faster action' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, x: 20 }}
          ...
          <div className="lg:hidden space-y-12">
            ...
            >
              ...
              <div className="relative space-y-8 max-w-md mx-auto">
                {[
                  { label: 'Data Collection', issue: 'Raw data dump' },
                  { label: 'Basic Dashboards', issue: 'No insights' },
                  { label: 'Monthly Reports', issue: 'Too late' },
                  { label: 'Manual Analysis', issue: 'Time-consuming' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, x: -20 }}
            ...
            >
              ...
              <div className="relative space-y-8 max-w-md mx-auto">
                ...
                {[
                  { label: 'Integrated Pipeline', benefit: 'Real-time data' },
                  { label: 'Smart Dashboards', benefit: 'Self-service' },
                  { label: 'Predictive Analytics', benefit: 'Future-focused' },
                  { label: 'Data-Driven', benefit: 'Faster action' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, x: 20 }}
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            {[
              { icon: Eye, text: 'See what matters with real-time visibility' },
              { icon: TrendingUp, text: 'Predict trends before they impact you' },
              { icon: Shield, text: 'Make confident decisions with accurate data' },
              { icon: BarChart3, text: 'Scale insights across your entire business' }
            ].map((item, i) => {
