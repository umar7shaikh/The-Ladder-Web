...
import { Search, Database, Settings, TrendingUp, ArrowRight, CheckCircle2 } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      icon: Search,
      title: 'Assessment',
      subtitle: 'Evaluating Your Data',
      description: 'We assess your current data infrastructure, identify all sources, and map out integration requirements. We find gaps and opportunities.',
      deliverables: [
    ...
    },
    {
      ...
      icon: Database,
      title: 'Architecture',
      subtitle: 'Designing Your Warehouse',
      description: 'We design your data warehouse architecture, define schemas, and plan ETL pipelines. Every decision optimized for performance and scale.',
      deliverables: [
    ...
    },
    {
      ...
      icon: Settings,
      title: 'Migration',
      subtitle: 'Building & Moving Data',
      description: 'We build ETL pipelines, migrate data, and set up real-time synchronization. You get progress updates throughout implementation.',
      deliverables: [
        'ETL pipelines',
        'Data migration',
    ...
    },
    {
      ...
      icon: TrendingUp,
      title: 'Optimization',
      subtitle: 'Fine-Tuning & Launch',
      description: 'We optimize performance, validate data quality, and provide training. Your unified data warehouse is ready for analytics.',
      deliverables: [
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          <p className="text-[#FBFFDE]/50 text-lg">
            A proven process that transforms scattered data into a unified, powerful warehouse
          </p>
        </motion.div>
        ...
        >
          <p className="text-[#FBFFDE]/50 text-base mb-6">
            Typical timeline: 8-14 weeks from assessment to optimization
          </p>
          <motion.a
