...
import { Sparkles, X, Check, Database, GitBranch, Zap, Shield } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          <h2 className="text-white font-bold text-[clamp(36px,6vw,56px)] leading-tight mb-4">
            Data infrastructure that unifies,<br />
            not fragments
          </h2>
          
          <div className="space-y-4 max-w-3xl mx-auto">
            <p className="text-[#FBFFDE]/60 text-xl leading-relaxed">
              Most data warehouses are disconnected silos that create more problems than they solve.
            </p>
            <p className="text-[#FBFFDE]/80 text-2xl leading-relaxed font-medium">
              We build <span className="text-[#D8F209]">unified data platforms</span> that centralize, integrate, and enable true business intelligence.
            </p>
          </div>
        </motion.div>
          ...
          <div className="hidden lg:grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <div className="relative space-y-12">
                {[
                  { label: 'Multiple Systems', time: 'Ongoing', issue: 'Data scattered' },
                  { label: 'Manual Integration', time: 'Monthly', issue: 'Error-prone' },
                  { label: 'Inconsistent Formats', time: 'Always', issue: 'Can\'t compare' },
                  { label: 'No Single Source', time: 'Never', issue: 'Conflicting data' },
                  { label: 'Expensive Maintenance', time: 'Ongoing', issue: 'High costs' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
            ...
            >
              ...
              <div className="relative space-y-12">
                ...
                {[
                  { label: 'Centralized Data Hub', benefit: 'Single source of truth' },
                  { label: 'Automated ETL Pipelines', benefit: 'Real-time sync' },
                  { label: 'Standardized Schema', benefit: 'Consistent format' },
                  { label: 'Integrated Systems', benefit: 'Everything connected' },
                  { label: 'Scalable Architecture', benefit: 'Grows with you' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, x: 20 }}
          ...
          <div className="lg:hidden space-y-12">
            ...
            >
              ...
              <div className="relative space-y-8 max-w-md mx-auto">
                {[
                  { label: 'Multiple Systems', issue: 'Data scattered' },
                  { label: 'Manual Integration', issue: 'Error-prone' },
                  { label: 'Inconsistent Formats', issue: 'Can\'t compare' },
                  { label: 'No Single Source', issue: 'Conflicting data' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, x: -20 }}
            ...
            >
              ...
              <div className="relative space-y-8 max-w-md mx-auto">
                ...
                {[
                  { label: 'Centralized Hub', benefit: 'Single source' },
                  { label: 'Automated Pipelines', benefit: 'Real-time sync' },
                  { label: 'Standardized Schema', benefit: 'Consistent' },
                  { label: 'Integrated Systems', benefit: 'Everything connected' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            {[
              { icon: Database, text: 'Centralize all data in one trusted platform' },
              { icon: GitBranch, text: 'Real-time synchronization across systems' },
              { icon: Shield, text: 'Secure, scalable, and enterprise-ready' },
              { icon: Zap, text: 'Enable analytics and BI from unified data' }
            ].map((item, i) => {
