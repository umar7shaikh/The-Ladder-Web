  ...
  const deliverables = [
    {
      ...
      description: 'Unified platform that stores and organizes all your business data in one place'
    },
    {
      title: 'ETL pipelines & data integration',
      description: 'Automated pipelines that extract, transform, and load data from all sources'
    },
    {
      title: 'Real-time data synchronization',
      description: 'Keep your warehouse updated in real-time as data changes across systems'
    },
    {
      title: 'Data quality & validation',
      description: 'Automated checks ensure data accuracy, consistency, and completeness'
    },
    {
      title: 'Scalable architecture',
      description: 'Built to handle growth—from gigabytes to petabytes without rebuilding'
    },
    {
      title: 'Documentation & training',
      description: 'Complete guides and training so your team can leverage the warehouse effectively'
    }
  ];
      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          <p className="text-[#FBFFDE]/60 text-lg max-w-2xl mx-auto">
            Everything you need for production-ready data warehousing that enables analytics
          </p>
        </motion.div>
        ...
        >
          <p className="text-[#FBFFDE]/50 text-base max-w-2xl mx-auto">
            Every component is tested, documented, and delivered with full training and ongoing support.
          </p>
        </motion.div>
