        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              >
                Let's build a website that actually supports your business
              </motion.h2>
              ...
              >
                Whether you're launching something new or rebuilding for scale, we'll help you create a website that works as hard as you do.
              </motion.p>
