...
export default function WhoThisIsFor() {
  ...
  const text = "This service is ideal for businesses handling high volumes of customer inquiries, struggling with repetitive support questions, wanting 24/7 availability without staffing costs, and ready to enhance customer experience with intelligent automation.";
