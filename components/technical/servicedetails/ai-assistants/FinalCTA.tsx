        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              >
                Build an AI assistant that actually helps
              </motion.h2>
              ...
              >
                Whether you're drowning in support tickets or want 24/7 customer service, we'll build AI that understands context and delivers real value.
              </motion.p>
            ...
            <div className="flex flex-col gap-8 lg:items-end">
              ...
              >
                ...
                <span>•</span>
                <span>Proof of concept included</span>
              </motion.div>
