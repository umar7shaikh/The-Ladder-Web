  ...
  const deliverables = [
    {
      ...
      description: 'Natural language understanding with context awareness and personality'
    },
    {
      title: 'Multi-channel deployment',
      description: 'Deploy to website, chat, email, voice, or any platform you need'
    },
    {
      title: 'Knowledge base integration',
      description: 'Connect to your documents, databases, and existing systems'
    },
    {
      title: 'Analytics & insights dashboard',
      description: 'Track conversations, satisfaction, and identify improvement opportunities'
    },
    {
      title: 'Human handoff system',
      description: 'Seamlessly escalate complex queries to your team when needed'
    },
    {
      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          <p className="text-[#FBFFDE]/60 text-lg max-w-2xl mx-auto">
            Everything you need for production-ready AI assistants that enhance customer experience
          </p>
        </motion.div>
