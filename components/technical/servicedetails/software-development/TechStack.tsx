...
>
  <div className="grid lg:grid-cols-2 gap-12 items-center">
    ...
    {/* Visual - Right side: Growth Curve */}
    <div className="relative lg:pl-12">
      <div className="relative bg-[#0D0D0D] rounded-xl border border-[#D8F209]/20 p-6 h-64 overflow-hidden">
        ...
        <div className="mt-8 pt-4 border-t border-[#D8F209]/10 flex justify-around">
          <div className="text-center">
            <div className="text-[#D8F209] text-xl font-bold">+980%</div>
            <div className="text-[#FBFFDE]/40 text-[10px]">Growth rate</div>
          </div>
          <div className="text-center">
            <div className="text-[#D8F209] text-xl font-bold">0</div>
            <div className="text-[#FBFFDE]/40 text-[10px]">Downtime</div>
          </div>
          <div className="text-center">
            <div className="text-[#D8F209] text-xl font-bold">Auto</div>
            <div className="text-[#FBFFDE]/40 text-[10px]">Scaling</div>
          </div>
        </div>
      </div>
    </div>
