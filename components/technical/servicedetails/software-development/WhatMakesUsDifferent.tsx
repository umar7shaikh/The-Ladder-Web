...
import { Sparkles, X, Check, Search, TrendingUp, Target, Users } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="lg:hidden space-y-12">
            ...
            >
              ...
              <div className="relative space-y-8 max-w-md mx-auto">
                {[
                  { label: 'Template Strategies', issue: 'No personalization' },
                  { label: 'Vanity Metrics', issue: 'No real value' },
                  { label: 'Random Posting', issue: 'No strategy' },
                  { label: 'No Data Tracking', issue: 'Can\'t optimize' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, x: -20 }}
            ...
            >
              ...
              <div className="relative space-y-8 max-w-md mx-auto">
                ...
                {[
                  { label: 'Custom Strategy', benefit: 'Tailored to you' },
                  { label: 'Performance Metrics', benefit: 'ROI-focused' },
                  { label: 'Data-Driven Content', benefit: 'Strategic' },
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            {[
              { icon: Search, text: 'SEO that actually drives organic traffic' },
              { icon: Target, text: 'Strategies aligned with your business goals' },
              { icon: TrendingUp, text: 'Data-driven decisions that improve ROI' },
              { icon: Users, text: 'Content that resonates with your audience' }
            ].map((item, i) => {
