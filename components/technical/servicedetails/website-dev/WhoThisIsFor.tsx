...
export default function WhoThisIsFor() {
  ...
  const text = "This service is ideal for businesses that need more than a good-looking website, are planning growth not just launch, want speed reliability and scalability, and care about long-term ROI from their website.";
