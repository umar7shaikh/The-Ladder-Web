...
import { Lightbulb, Pencil, Code2, Rocket, ArrowRight, CheckCircle2 } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      description: 'We start by understanding your business goals, target audience, and success metrics. No assumptions—just clarity.',
      deliverables: [
        'Project roadmap',
    ...
    },
    {
      ...
      description: 'We design interfaces that users love and convert. Every pixel serves your business goals.',
      deliverables: [
        'Wireframes & mockups',
        'Design system',
    ...
    },
    {
      ...
      description: 'Clean code, tested thoroughly, built to scale. You get updates every step of the way.',
      deliverables: [
    ...
    },
    {
      ...
      description: 'We handle deployment, monitoring, and provide ongoing support. Your success is our success.',
      deliverables: [
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          <p className="text-[#FBFFDE]/50 text-base mb-6">
            Typical timeline: 8-12 weeks from kickoff to launch
          </p>
          <motion.a
