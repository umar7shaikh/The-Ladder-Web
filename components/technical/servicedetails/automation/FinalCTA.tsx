        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              >
                Stop doing manually what can run automatically
              </motion.h2>
              ...
              >
                Whether you're spending hours on data entry or drowning in repetitive tasks, we'll build automation that gives you your time back.
              </motion.p>
            ...
            <div className="flex flex-col gap-4 lg:items-end">
              ...
              >
                ...
                <span>•</span>
                <span>See what can be automated</span>
              </motion.div>
