...
export default function WhoThisIsFor() {
  ...
  const text = "This service is ideal for businesses drowning in repetitive tasks, spending hours on manual data entry, struggling with human errors and inconsistencies, and ready to scale without hiring more staff.";
