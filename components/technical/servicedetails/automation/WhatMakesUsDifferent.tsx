...
import { ArrowRight, Zap, Shield, TrendingUp, Sparkles, X, Check, Clock, DollarSign } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          <h2 className="text-white font-bold text-[clamp(36px,6vw,56px)] leading-tight mb-4">
            Automation that adapts,<br />
            not breaks
          </h2>
          
          <div className="space-y-4 max-w-3xl mx-auto">
            <p className="text-[#FBFFDE]/60 text-xl leading-relaxed">
              Most automation fails because it's rigid and breaks when things change.
            </p>
            <p className="text-[#FBFFDE]/80 text-2xl leading-relaxed font-medium">
              We build <span className="text-[#D8F209]">intelligent automation</span> that adapts to your evolving business needs.
            </p>
          </div>
        </motion.div>
          ...
          <div className="hidden lg:grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <div className="relative space-y-12">
                {[
                  { label: 'Hard-coded Scripts', time: 'Week 1-2', issue: 'No flexibility' },
                  { label: 'Manual Setup', time: 'Week 3-4', issue: 'Time-consuming' },
                  { label: 'Process Changes', time: 'Month 2', issue: 'Automation breaks' },
                  { label: 'Maintenance', time: 'Ongoing', issue: 'Constant fixes' },
                  { label: 'Updates Required', time: 'Monthly', issue: 'Expensive patches' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
            ...
            >
              ...
              <div className="relative space-y-12">
                ...
                {[
                  { label: 'Discovery & Mapping', benefit: 'Understand your workflow' },
                  { label: 'Smart Design', benefit: 'Built for flexibility' },
                  { label: 'Error Handling', benefit: 'Self-healing automation' },
                  { label: 'Monitoring', benefit: 'Proactive alerts' },
                  { label: 'Continuous Optimization', benefit: 'Learns and improves' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, x: 20 }}
          ...
          <div className="lg:hidden space-y-12">
            ...
            >
              ...
              <div className="relative space-y-8 max-w-md mx-auto">
                {[
                  { label: 'Hard-coded Scripts', issue: 'No flexibility' },
                  { label: 'Manual Setup', issue: 'Time-consuming' },
                  { label: 'Process Changes', issue: 'Automation breaks' },
                  { label: 'Maintenance', issue: 'Constant fixes' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, x: -20 }}
            ...
            >
              ...
              <div className="relative space-y-8 max-w-md mx-auto">
                ...
                {[
                  { label: 'Discovery', benefit: 'Map your workflow' },
                  { label: 'Smart Design', benefit: 'Built flexible' },
                  { label: 'Error Handling', benefit: 'Self-healing' },
                  { label: 'Optimization', benefit: 'Learns & improves' }
                ].map((step, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, x: 20 }}
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            {[
              { icon: Clock, text: 'Save 20+ hours per week on repetitive tasks' },
              { icon: DollarSign, text: 'Reduce operational costs by 40-60%' },
              { icon: Shield, text: 'Eliminate human error with smart validation' },
