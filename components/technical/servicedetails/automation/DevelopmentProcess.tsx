...
import { Search, Settings, Code2, PlayCircle, ArrowRight, CheckCircle2 } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      icon: Search,
      title: 'Analysis',
      subtitle: 'Mapping Your Workflow',
      description: 'We analyze your current processes to identify automation opportunities and calculate ROI. Every automation starts with understanding what needs to change.',
      deliverables: [
    ...
    },
    {
      ...
      icon: Settings,
      title: 'Design',
      subtitle: 'Planning the Automation',
      description: 'We design the automation architecture, error handling strategies, and integration points. Nothing gets automated without a solid plan.',
      deliverables: [
    ...
    },
    {
      ...
      description: 'We build, test, and refine your automation. You get regular demos and can request adjustments before final deployment.',
      deliverables: [
        'Automated workflows',
    ...
    },
    {
      ...
      icon: PlayCircle,
      title: 'Deployment',
      subtitle: 'Going Live & Monitoring',
      description: 'We deploy to production, monitor performance, and optimize based on real-world data. Your automation runs smoothly from day one.',
      deliverables: [
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          <p className="text-[#FBFFDE]/50 text-lg">
            A proven process that transforms repetitive tasks into intelligent automation
          </p>
        </motion.div>
        ...
        >
          <p className="text-[#FBFFDE]/50 text-base mb-6">
            Typical timeline: 4-10 weeks from analysis to deployment
          </p>
          <motion.a
