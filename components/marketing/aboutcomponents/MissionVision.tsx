  ...
  return (
    <section className="relative w-full py-16 md:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-screen-xl 2xl:max-w-screen-2xl mx-auto px-6 md:px-12 lg:px-20 xl:px-32">
        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-between gap-16 min-h-[500px]">
          ...
          <div className="w-full lg:w-[38%] flex items-center">
            <div className="flex flex-col gap-6 max-w-[536px]">
              ...
              <div className="inline-flex items-center justify-center w-fit px-4 py-2 bg-[#FFE000] rounded-full">
                <span className="text-xs font-semibold text-[#363A43]">Our Mission and Vision</span>
              </div>
          ...
          <div className="w-full lg:w-[52%] lg:pl-12 xl:pl-16 flex flex-col gap-12 z-10">
            
            {/* Card 1 - Client Success First (No shadow/border) */}
            <div className="bg-white rounded-xl flex items-center gap-3 relative h-[138px] pl-[100px] pr-8 py-[22px]">
              <div className="flex-shrink-0 w-12 h-12 bg-[#FFE000] rounded-full flex items-center justify-center absolute left-8">
              ...
              <div className="flex flex-col gap-2">
                <h3 className="text-lg font-bold text-[#363A43] font-poppins">Client Success First</h3>
                <p className="text-sm text-[#363A43]/70 leading-relaxed">We put our clients' goals at the heart of every campaign we create.</p>
              </div>
            </div>


            {/* Card 2 - Data-Driven Growth (Icon and content shifted more right) */}
            <div className="bg-[#FFE000] rounded-xl shadow-lg flex items-center gap-3 relative h-[138px] pl-[220px] pr-4 py-[22px]">
            <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center absolute left-36 z-30">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#363A43]">
            ...
            <div className="flex flex-col gap-2">
                <h3 className="text-lg font-bold text-[#363A43] font-poppins">Data-Driven Growth</h3>
                <p className="text-sm text-[#363A43]/70 leading-relaxed">Using insights and analytics to drive smarter decisions and better results.</p>
            </div>
            </div>
            ...
            <div className="bg-white rounded-xl flex items-center gap-3 relative h-[138px] pl-[100px] pr-8 py-[22px]">
              ...
              <div className="flex flex-col gap-2">
                <h3 className="text-lg font-bold text-[#363A43] font-poppins">Trusted Partnerships</h3>
                <p className="text-sm text-[#363A43]/70 leading-relaxed">Building lasting relationships based on transparency, trust, and results.</p>
              </div>
            </div>
