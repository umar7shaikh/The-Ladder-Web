  ...
  return (
    <section className="relative w-full bg-white py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="w-full max-w-screen-xl 2xl:max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-12 lg:px-16 xl:px-20 2xl:px-32">
        ...
        {/* Header */}
        <div className="flex flex-col items-center text-center gap-3 sm:gap-4 mb-12 sm:mb-14 lg:mb-16">
          <h2 className="text-[clamp(28px,5vw,48px)] leading-tight font-bold text-[#363A43] font-poppins">
            Get In Touch With Our Experts
          </h2>
          <p className="text-[clamp(14px,3.5vw,16px)] text-[#363A43]/70 max-w-3xl px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center gap-3 sm:gap-4">
            {/* Icon Circle */}
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#FFE000] rounded-full flex items-center justify-center">
            ...
            {/* Title */}
            <h3 className="text-[clamp(16px,4vw,18px)] font-bold text-[#363A43] font-poppins">EMAIL</h3>

            {/* Description */}
            <p className="text-[clamp(13px,3vw,14px)] text-[#363A43]/70 leading-relaxed max-w-xs">
            ...
            <div className="w-full bg-[#FFF9CE] rounded-lg py-3 px-4">
              <a href="mailto:info@theladder.com" className="text-[clamp(12px,3vw,14px)] font-medium text-[#363A43] hover:underline break-all">
                info@theladder.com
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center gap-3 sm:gap-4">
            ...
            {/* Title */}
            <h3 className="text-[clamp(16px,4vw,18px)] font-bold text-[#363A43] font-poppins">PHONE</h3>
          ...
          <div className="flex flex-col items-center text-center gap-3 sm:gap-4">
            ...
            {/* Title */}
            <h3 className="text-[clamp(16px,4vw,18px)] font-bold text-[#363A43] font-poppins">OFFICE</h3>
            ...
            {/* Office Box */}
            <div className="w-full bg-[#FFF9CE] rounded-lg py-3 px-4">
              <span className="text-[clamp(12px,3vw,14px)] font-medium text-[#363A43]">
                The Ladder
              </span>
            </div>
          </div>
        ...
        {/* Divider Line */}
        <div className="w-full border-t border-[#363A43]/10 mt-12 sm:mt-14 lg:mt-16"></div>
