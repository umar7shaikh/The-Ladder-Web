    ...
    <section className="relative w-full bg-[#363A43] py-12 sm:py-16 md:py-20 lg:py-24 overflow-hidden">
      <div className="w-full max-w-screen-xl 2xl:max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-12 lg:px-16 xl:px-20 2xl:px-32">
        ...
        <div className="text-center mb-10 sm:mb-12 lg:mb-16">
          ...
          <p className="text-[#FFF9CE] text-[clamp(14px,3.5vw,18px)] leading-relaxed max-w-4xl mx-auto px-4">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0">
            ...
            <div 
              className="h-56 sm:h-60 md:h-64 relative gradient-border-rb flex flex-col items-center justify-center text-center p-4 sm:p-6 space-y-3 sm:space-y-4"
              style={{
                background: 'linear-gradient(to right, rgba(255, 224, 0, 0.05), rgba(255, 224, 0, 0.2))'
              }}
            >
              <div className="w-[clamp(44px,10vw,56px)] h-[clamp(44px,10vw,56px)] bg-[#FFE000] rounded-lg flex items-center justify-center text-[#363A43] p-3">
                {services[0].icon}
              </div>
              <h3 className="text-[clamp(16px,4vw,20px)] font-bold text-[#FFE000] font-poppins">{services[0].title}</h3>
              <p className="text-[clamp(12px,3vw,14px)] text-[#FFF9CE] max-w-[200px]">{services[0].description}</p>
            </div>
            
            {/* Box 2 - Top Center - Social Media Marketing */}
            <div className="h-56 sm:h-60 md:h-64 bg-transparent relative gradient-border-lb flex flex-col items-center justify-center text-center p-4 sm:p-6 space-y-3 sm:space-y-4">
              <div className="w-[clamp(44px,10vw,56px)] h-[clamp(44px,10vw,56px)] bg-[#FFE000] rounded-lg flex items-center justify-center text-[#363A43] p-3">
                {services[1].icon}
              </div>
              <h3 className="text-[clamp(16px,4vw,20px)] font-bold text-[#FFE000] font-poppins">{services[1].title}</h3>
              <p className="text-[clamp(12px,3vw,14px)] text-[#FFF9CE] max-w-[200px]">{services[1].description}</p>
            </div>
            
            {/* Box 3 - Top Right - Graphic Designing */}
            <div 
              className="h-56 sm:h-60 md:h-64 flex flex-col items-center justify-center text-center p-4 sm:p-6 space-y-3 sm:space-y-4"
              style={{
            ...
            >
              ...
              <h3 className="text-[clamp(16px,4vw,20px)] font-bold text-[#FFE000] font-poppins">{services[2].title}</h3>
              <p className="text-[clamp(12px,3vw,14px)] text-[#FFF9CE] max-w-[200px]">{services[2].description}</p>
            </div>
            
            {/* Box 4 - Bottom Left - SEO & Backlinking */}
            <div className="h-56 sm:h-60 md:h-64 bg-transparent relative gradient-border-tr flex flex-col items-center justify-center text-center p-4 sm:p-6 space-y-3 sm:space-y-4">
              <div className="w-[clamp(44px,10vw,56px)] h-[clamp(44px,10vw,56px)] bg-[#FFE000] rounded-lg flex items-center justify-center text-[#363A43] p-3">
                {services[3].icon}
              </div>
              <h3 className="text-[clamp(16px,4vw,20px)] font-bold text-[#FFE000] font-poppins">{services[3].title}</h3>
              <p className="text-[clamp(12px,3vw,14px)] text-[#FFF9CE] max-w-[200px]">{services[3].description}</p>
            </div>
            
            {/* Box 5 - Bottom Center - Email Marketing */}
            <div 
              className="h-56 sm:h-60 md:h-64 relative gradient-border-tlr flex flex-col items-center justify-center text-center p-4 sm:p-6 space-y-3 sm:space-y-4"
              style={{
                background: 'linear-gradient(to right, rgba(255, 224, 0, 0.05), rgba(255, 224, 0, 0.2))'
              }}
            >
              ...
              <h3 className="text-[clamp(16px,4vw,20px)] font-bold text-[#FFE000] font-poppins">{services[4].title}</h3>
              <p className="text-[clamp(12px,3vw,14px)] text-[#FFF9CE] max-w-[200px]">{services[4].description}</p>
            </div>
            
            {/* Box 6 - Bottom Right - Paid Ads Campaigns */}
            <div className="h-56 sm:h-60 md:h-64 bg-transparent relative gradient-border-l flex flex-col items-center justify-center text-center p-4 sm:p-6 space-y-3 sm:space-y-4">
              <div className="w-[clamp(44px,10vw,56px)] h-[clamp(44px,10vw,56px)] bg-[#FFE000] rounded-lg flex items-center justify-center text-[#363A43] p-3">
                {services[5].icon}
              </div>
              <h3 className="text-[clamp(16px,4vw,20px)] font-bold text-[#FFE000] font-poppins">{services[5].title}</h3>
              <p className="text-[clamp(12px,3vw,14px)] text-[#FFF9CE] max-w-[200px]">{services[5].description}</p>
            </div>
...
function LadderBadge() {
  return (
    <div className="relative flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-full bg-[#363A43] border border-[#FFE000]/30 shadow-xl">
      ...
      <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-full bg-[#FFE000] shadow-[0_0_20px_rgba(255,224,0,0.3)]">
        {/* Your Custom Ladder SVG */}
        <svg width="11" height="29" viewBox="0 0 11 29" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-2.5 h-auto sm:w-3 lg:w-3.5">
