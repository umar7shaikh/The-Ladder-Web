        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12 xl:gap-16 2xl:gap-20">
          ...
          <div className="w-full lg:w-[48%] flex flex-col gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="inline-flex items-center justify-center w-fit px-4 py-2 bg-[#FFE000] rounded-full">
              <span className="text-[clamp(11px,2.5vw,12px)] font-semibold text-[#363A43]">Who We Are</span>
            </div>
            ...
            <div className="pt-2">
              <Link
                ...
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 h-[clamp(44px,10vw,48px)] bg-[#FFE000] text-[#363A43] rounded-lg text-[clamp(14px,3.5vw,16px)] font-semibold hover:bg-[#FFF9CE] transition-all duration-300 shadow-md hover:shadow-lg"
              >
                Learn More About Us
              </Link>
            </div>
